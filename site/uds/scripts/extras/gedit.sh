...
dconf write /org/gnome/gedit/plugins/active-plugins "['terminal', 'spell', 'sort', 'modelines', 'filebrowser', 'docinfo']"
dconf write /org/gnome/gedit/preferences/editor/editor-font "'Ubuntu Mono 11'"
